...
class StoreReporteRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            "fecha_inicio" => [Rule::requiredIf(fn() => $this->input('tipo_reporte') === 'cierre_programado'), 'date|after_or_equal:today'],
            "fecha_fin" => [Rule::requiredIf(fn() => $this->input('tipo_reporte') === 'cierre_programado'), 'date|after_or_equal:fecha_inicio'],
